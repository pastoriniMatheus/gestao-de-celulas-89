...
export const MinistriesManager = () => {
  ...
  // Filtrar ministérios baseado nas permissões
  const displayedMinistries = getLeaderMinistries();
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Dialog de Edição */}
      {canEditMinistry(selectedMinistry?.id) && (
